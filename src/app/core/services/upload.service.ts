...
import { SignedUrlResponse, UploadProgressEvent } from '../interfaces/upload.interface';
...
export class UploadService {
  ...
  public uploadFile(signedUrl: string, file: File, progress: WritableSignal<number>): Promise<void> {
    return new Promise<void>((resolve: (value: void | PromiseLike<void>) => void, reject: (reason?: Error) => void): void => {
